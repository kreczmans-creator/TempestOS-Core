...
/// <summary>
/// Shared construction for the archived half of the `P07` test suite:
/// Contracts, Risk/Insurance, IP/Data assets, Finance (Assumption/
/// Scenario), Opportunity, Operating.
/// </summary>
/// <remarks>
/// WP 18.0C (D-028): split out of the live
/// tests/Tempest.Core.Tests/BusinessGovernance/BusinessGovernanceFixtures.cs
/// the same day Money/EffectivePeriod/the governance-authority-evidence
/// primitives/RateCard stayed live; every value here is fictional, as it
/// always was.
/// </remarks>
