...
/// <summary>
/// Shared construction for the archived half of the `P04` test suite:
/// Interaction, FinancialEntry, Purchasing, Quality and Records.
/// </summary>
/// <remarks>
/// WP 18.0C (D-028): split out of the live
/// tests/Tempest.Core.Tests/BusinessOperations/OperationsFixtures.cs the
/// same day its Organisation/Contact/Budget half stayed live; every value
