...
public class IdentityServiceTests
{
    ...
    // EstablishCurrentPrincipal's trust gate (WP 13.10B, TD-52) and its
    // tests here were frozen by ADR-0146 (WP 17.2A) along with the plugin
    // trust platform - see src/Frozen/README.md. IdentityService no longer
    // takes a component accessor or permission evaluator at all.
