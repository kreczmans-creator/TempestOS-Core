...
/// mirrors <c>Tempest.Core.Tests.Settings.InMemoryPersistenceStore</c>'s
/// own convention, duplicated here rather than shared, per this
/// codebase's own established precedent of small, test-local fakes
/// (<c>RecordingLevelLogger</c> exists independently in both
/// <c>Tests.Events</c> and <c>Tests.Plugins</c>).
/// </summary>
