...
/// already establishes, for Expense's own tests (`WP 21.3B`).
/// </summary>
internal static class ExpenseTestHost
{
    public const string PrincipalId = "expense-test-principal-01";
    ...
    public static async Task<Guid> CreateProjectAsync(ITempestHost host, string identifier = "EXP-PRJ", string name = "Expense Test Project")
    {
        ...
        var project = await factory.CreateAsync("Expense test project.");
        return project.Id;
    }
}
