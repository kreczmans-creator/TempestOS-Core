...
public class ReflectionFrameworkDiscoveryServiceTests
{
    ...
    // The isTypeExcluded predicate (WP 13.9.6, Module Discovery Trust
    // Boundary Remediation) and its two tests here were frozen by ADR-0146
    // (WP 17.2A) along with the plugin trust platform it existed to close a
    // gap for - see src/Frozen/README.md.
}
