...
/// document-backed store rather than an in-memory shortcut, for the kept
/// `P05` libraries: Templates, CalculationPacks, Verification.
/// </summary>
/// <remarks>
/// Create, persist, reload, compare, revise, retrieve the historical
/// revision, supersede, retrieve the superseded record. The `P03`
/// <c>CostFigure</c> defect went undetected precisely because nothing
/// exercised this path.
///
/// WP 18.0C (D-028): the design-review and technical-document tests
/// moved to tests/Frozen/Tempest.Core.Tests/EngineeringAssets/
/// EngineeringAssetPersistenceTests.cs alongside the kinds they cover.
/// </remarks>
public sealed class EngineeringAssetPersistenceTests
{
    ...
    public void Every_kept_P05_asset_type_round_trips_through_JSON(object asset)
    {
