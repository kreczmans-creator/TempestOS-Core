...
/// <see cref="Tempest.Core.Tests.Events.RecordingLevelLogger"/>. Used
/// here to prove <c>ReportingService</c>'s own Logging Requirements — a
/// renderer failure is logged at <see cref="LogLevel.Warning"/>.
/// </summary>
