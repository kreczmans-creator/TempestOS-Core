...
/// <summary>A hand-written, in-memory <see cref="IPersistenceStore"/> test double — mirrors every other test folder's own identical, deliberately-duplicated convention (see <c>Tempest.Core.Tests.Settings.InMemoryPersistenceStore</c>'s own remarks).</summary>
