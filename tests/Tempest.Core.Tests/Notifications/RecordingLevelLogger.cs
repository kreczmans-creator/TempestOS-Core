...
/// severity it was logged at, mirroring
/// <see cref="Tempest.Core.Tests.Events.RecordingLevelLogger"/>. Used here to
/// prove ADR-0046's logging requirement — an isolated subscriber failure is
/// logged at <see cref="LogLevel.Warning"/> (not <see cref="LogLevel.Error"/>,
/// the level <c>EventBus</c> itself uses) — not merely that something was
/// logged.
/// </summary>
