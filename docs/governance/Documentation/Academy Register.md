...
## 02 Runtime Architecture (15 articles)
...
**Total: 1 (Introduction) + 11 (Engineering Principles) + 15 (Runtime
Architecture) + 56 (Work Packages) + 5 (Design Patterns) + 5 (Case
Studies) + 5 (Engineering Standards) + 4 (top-level meta) = 102 files
...
`WP 7.2A`, `WP 7.2B`, `WP 7.2C`), not just the grand total, continuing
