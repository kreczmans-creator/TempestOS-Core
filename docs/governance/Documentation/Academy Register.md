...
## 03 Work Packages (57 retrospectives)
...
Architecture) + 62 (Work Packages) + 5 (Design Patterns) + 5 (Case
Studies) + 5 (Engineering Standards) + 4 (top-level meta) = 110 files
...
`WP 8.0B`, `WP 8.1A`, `WP 8.0C`), not just the grand total, continuing
...
`WP 8.0A`) was updated in place three times — by `WP 8.0B`, `WP 8.1A`,
then `WP 8.0C` — none of the three counted as a new file.
**Correction, `WP
