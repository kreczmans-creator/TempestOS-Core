...
## 02 Runtime Architecture (16 articles)
...
**Total: 1 (Introduction) + 11 (Engineering Principles) + 16 (Runtime
Architecture) + 58 (Work Packages) + 5 (Design Patterns) + 5 (Case
Studies) + 5 (Engineering Standards) + 4 (top-level meta) = 105 files
...
`WP 7.2A`, `WP 7.2B`, `WP 7.2C`, `WP 7.3A`, `WP 7.4.0`), not just the
