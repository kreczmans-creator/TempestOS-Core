...
Architecture) + 60 (Work Packages) + 5 (Design Patterns) + 5 (Case
Studies) + 5 (Engineering Standards) + 4 (top-level meta) = 108 files
...
`WP 8.0B`), not just the grand total, continuing the standing practice
`WP 5.4`'s own repository review recommended. `02 Runtime Architecture/
17-engineering-workspace.md` (introduced by `WP 8.0A`) was updated in
place by `WP 8.0B`, not counted as a new file.
**Correction, `WP
