...
## 03 Work Packages (53 retrospectives)
...
Architecture) + 53 (Work Packages) + 5 (Design Patterns) + 5 (Case
Studies) + 5 (Engineering Standards) + 4 (top-level meta) = 99 files
...
not just the grand total, continuing the standing practice `WP 5.4`'s
own repository review recommended.
**Correction, `WP
