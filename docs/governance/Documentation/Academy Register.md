...
## 02 Runtime Architecture (17 articles)
...
## 03 Work Packages (58 retrospectives)
...
**Total: 1 (Introduction) + 11 (Engineering Principles) + 17 (Runtime
Architecture) + 63 (Work Packages) + 5 (Design Patterns) + 5 (Case
Studies) + 5 (Engineering Standards) + 4 (top-level meta) = 111 files
...
`WP 8.0B`, `WP 8.1A`, `WP 8.0C`, `WP 8.1B`), not just the grand total,
continuing the standing practice `WP 5.4`'s own repository review
recommended. `02 Runtime Architecture/17-engineering-workspace.md`
(introduced by `WP 8.0A`) was updated in place four times — by
`WP 8.0B`, `WP 8.1A`, `WP 8.0C`, then `WP 8.1B` — none of the four
