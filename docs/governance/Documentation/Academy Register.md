...
| **Last Reviewed** | 2026-07-29 (WP 6.6, Licensing) — added `WP6.6-licensing-framework-implementation.md`. |
...
## 03 Work Packages (43 retrospectives)
...
Architecture) + 43 (Work Packages) + 4 (Design Patterns) + 5 (Case
Studies) + 5 (Engineering Standards) + 4 (top-level meta) = 85 files
under `docs/academy/` — re-verified by direct `find` count against every
subfolder individually (`WP 6.1`, `WP 6.4`, `WP 6.5`, `WP 6.2`, `WP
6.0`, `WP 6.3`, `WP 6.7`, `WP 6.6`), not just the grand total, continuing
