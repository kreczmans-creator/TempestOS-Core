...
|---|---|---|
| `docs/adr/` | 61 Architecture Decision Records | `ADR Register.md` |
...
| `docs/academy/02 Runtime Architecture/` | 16 concept guides synthesising the runtime | `Academy Register.md` |
| `docs/academy/03 Work Packages/` | 58 Work Package retrospectives | `Academy Register.md`; `Feature Register.md` |
