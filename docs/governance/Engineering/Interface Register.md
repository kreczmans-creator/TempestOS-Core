...
**Total: 168 public interfaces under `src/Tempest.Core/` — Verified
directly (`grep -rhoP "^public interface \w+(<[^>]+>)?" src/Tempest.Core`
returns exactly 167 matches, matching the 80 rows above plus the 87
