...
**Total: 21 production modules — Verified directly via
`ClockModuleDiscoveryTests.DiscoverModules_ScopedToSampleAssembly_FindsEveryRealSampleModule`,
which asserts exactly 21 and names each by Id and type; all 21 are
listed above. `WorkspaceExplorerSampleModule` (`WP 8.1B`) was recorded
