...
| **Scope** | Every `namespace` declaration under `src/Tempest.Core/`, `src/Tempest.App/`, `src/Samples/Tempest.Samples/`, and, since `WP 12.3B`, `src/Validation/Tempest.Validation/`. |
...
| **Related ADRs** | ADR-0016, ADR-0024, ADR-0036, ADR-0037, ADR-0038, ADR-0039, ADR-0040, ADR-0046, ADR-0047, ADR-0048, ADR-0049, ADR-0050, ADR-0051, ADR-0102. |
