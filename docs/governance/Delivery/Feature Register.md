...
| Navigation Framework Implementation | Not started | WP 5.0B (formerly WP 4.6B, planned, blocked on 5.0A) |
...
**Total: 25 features tracked — 18 Implemented/Complete (17 from `v0.4.0`'s
shipped scope, plus `WP 5.0A`), 4 Not Started (renumbered from `v0.4.0`'s
deferred scope — see `docs/releases/v0.5.0/ReleasePlan.md`'s "A Note on
Renumbering"), 2 audit/review milestones (no code by design).**
