...
| **Last Reviewed** | 2026-07-29 (WP 6.1, Permissions & Identity). |
...
| **Related ADRs** | All 41 — this register's entire subject matter. |
...
**Total: 41 ADRs, all Accepted, none superseded or reversed (Verified — no
...
`ADR-0040`–`ADR-0042`, followed by `ADR-0043`–`ADR-0044` — not a
...
Packages began implementation. `WP 6.1` is the first of those Work
Packages to actually implement, and its own two reserved numbers
(`ADR-0043`, `ADR-0044`) are now real, Accepted files; `ADR-0040`–
`ADR-0042` and `ADR-0045`–`ADR-0051` remain reserved for their own
