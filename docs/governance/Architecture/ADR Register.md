...
| **Related ADRs** | All 76 — this register's entire subject matter. |
...
**Total: 76 ADRs, all Accepted, none superseded or reversed (Verified — no
...
Sequential and complete, `ADR-0001` through `ADR-0076`, with no gaps at
...
picking one reading over the other. `docs/releases/v0.7.0/WP7.0C Required ADR Catalogue.md` reserved
