...
| **Related ADRs** | All 85 — this register's entire subject matter. |
...
**Total: 85 ADRs, all Accepted, none superseded or reversed (Verified — no
...
Sequential and complete, `ADR-0001` through `ADR-0085`, with no gaps at
