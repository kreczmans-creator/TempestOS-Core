...
- [ADR Register](Architecture/ADR%20Register.md) — all 126 Architecture Decision Records (`ADR-0001`–`ADR-0126`; `ADR-0125`/`ADR-0126` added `Group A` for affine units and the shared reference-data layer; `ADR-0124` added `A4` for the Bearing Library; `ADR-0121`/`ADR-0122` added `WP 16.4B-R1` after the `v0.16.0` review board found two decisions this release took without the ADR Governance §5 requires).
