...
- [ADR Register](Architecture/ADR%20Register.md) — all 122 Architecture Decision Records (`ADR-0001`–`ADR-0122`; `ADR-0121`/`ADR-0122` added `WP 16.4B-R1` after the `v0.16.0` review board found two decisions this release took without the ADR Governance §5 requires).
