...
| *(pending push)* | WP 14.2A | Android & iOS platform heads: library/heads restructure, `Tempest.Companion.Mobile.slnx`, dispatch-only `mobile-heads.yml` (`ADR-0116`); `TD-57` → Partially resolved |
