...
/// <summary>
/// Restores one soft-deleted Mechanical Product Structure object
...
/// </remarks>
public sealed class UndeleteMechanicalObjectCommand : IWorkspaceCommand
{
    public UndeleteMechanicalObjectCommand(Guid targetObjectId, string targetKind)
    {
...
/// <summary>Handles <see cref="UndeleteMechanicalObjectCommand"/>.</summary>
public sealed class UndeleteMechanicalObjectCommandHandler : ICommandHandler<UndeleteMechanicalObjectCommand>
{
    private readonly EngineeringDomainContext _context;

    public UndeleteMechanicalObjectCommandHandler(EngineeringDomainContext context)
    {
    ...
    public async Task<CommandResult> HandleAsync(UndeleteMechanicalObjectCommand command, CancellationToken cancellationToken)
    {
