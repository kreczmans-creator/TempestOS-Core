...
/// <summary>
/// Restores one soft-deleted Manufacturing Domain object
...
/// </remarks>
public sealed class UndeleteManufacturingObjectCommand : IWorkspaceCommand
{
    public UndeleteManufacturingObjectCommand(Guid targetObjectId, string targetKind)
    {
...
/// <summary>Handles <see cref="UndeleteManufacturingObjectCommand"/>.</summary>
public sealed class UndeleteManufacturingObjectCommandHandler : ICommandHandler<UndeleteManufacturingObjectCommand>
{
    private readonly EngineeringDomainContext _context;

    public UndeleteManufacturingObjectCommandHandler(EngineeringDomainContext context)
    {
    ...
    public async Task<CommandResult> HandleAsync(UndeleteManufacturingObjectCommand command, CancellationToken cancellationToken)
    {
