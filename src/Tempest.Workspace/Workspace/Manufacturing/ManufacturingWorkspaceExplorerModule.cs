...
/// navigation model — the area ManufacturingWorkspaceRegistration attaches
/// <see cref="ManufacturingNodeProvider"/> to.
/// </summary>
/// <remarks>
/// <para>
...
/// assembly removed the Manufacturing area — Operations, Work Instructions and Inspections. The
...
/// <see cref="ManufacturingWorkspaceRegistration"/>, which is why the two must
/// agree on <see cref="NavigationItemId"/> and now do so from the same
/// assembly.
/// </para>
/// </remarks>
[ModuleMetadata("tempest.manufacturing.workspace-explorer", "Manufacturing Workspace Explorer", "1.0.0")]
public sealed class ManufacturingWorkspaceExplorerModule : ModuleLifecycleBase
{
    ...
    public ManufacturingWorkspaceExplorerModule(INavigationProvider navigationProvider)
        : base("tempest.manufacturing.workspace-explorer", "Manufacturing Workspace Explorer", "1.0.0")
    {
