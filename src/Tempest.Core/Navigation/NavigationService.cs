...
/// component-scope accessor and an optional permission evaluator: a
/// higher-trust-tier plugin could evict a lower one's item, and a plugin
/// removing another plugin's item needed a reserved
/// <c>navigation.unregister.any</c> permission that nothing ever granted.
/// Nothing third-party ever loaded, so registration is unconditional
/// duplicate rejection again — exactly what <c>ADR-0032</c> originally
/// specified — and unregistration is unconditional. The trust platform is
/// frozen at <c>src/Frozen/Tempest.Core.Plugins</c>.
/// </para>
/// </remarks>
