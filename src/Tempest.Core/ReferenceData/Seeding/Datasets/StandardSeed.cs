...
public sealed class StandardSeed : IReferenceSeed<StandardDefinition>
{
    ...
    [
        ...
        Titled(Iso286Part2, Iso, "ISO 286-2", "2010",
        ...
        Untitled(En10025Part2, Cen, "EN 10025-2", "2019",
            StandardClassification.Specification,
        ...
        Untitled(En573Part3, Cen, "EN 573-3", null,
        ...
        Untitled(En485Part2, Cen, "EN 485-2", "2008",
            StandardClassification.Specification,
            [StandardDiscipline.Materials],
    ...
    private static ReferenceSeedRecord<StandardDefinition> Titled(
        ...
        new(recordId,
            ...
            SeedSources.TertiaryReference("List of ISO standards 1–1999", $"row for {designation}", designation));
    ...
    private static ReferenceSeedRecord<StandardDefinition> Untitled(
        ...
        new(recordId,
            ...
            SeedSources.StandardsCatalogue(
                body.Name ?? body.Code,
                $"citation of {designation} in the datasheet the citing record was transcribed from"));
}
