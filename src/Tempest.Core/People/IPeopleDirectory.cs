...
/// </param>
// `Person` is the People library's own record (`WP 20.10F`, Person.cs); `WP 21.3B`'s stand-in
// definition was removed at merge and `PersonCatalogPeopleDirectory` adapts the library to this seam.
