...
/// higher-trust-tier plugin could evict a lower one's descriptor. Nothing
/// third-party ever loaded, so registration is unconditional duplicate
/// rejection again — exactly what <c>ADR-0037</c> originally specified — and
/// the trust platform is frozen at <c>src/Frozen/Tempest.Core.Plugins</c>.
/// </para>
/// </remarks>
