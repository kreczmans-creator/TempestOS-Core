...
/// <param name="SpecificationPath">The repository path of its specification.</param>
...
/// <summary>
/// The eleven `WP 21.7A` calculation modules, described for a catalogue and
/// a generated form: id, title, category, method reference, and every input
/// with its label, unit, limits and meaning.
/// </summary>
/// <remarks>
/// <para>
...
/// it cannot say what the parameter means, what limits apply, or which unit
/// an engineer would expect to type. Those are engineering facts and they
/// live here, once, beside the definitions they describe. The lead session
/// asked for this in `WP 21.7A` so that `WP 21.7B` (the dynamic calculator
/// surface the Product Owner wants) can generate its forms from data.
/// </para>
/// <para>
/// <b>Kept honest by a test.</b> Every descriptor's input names are asserted
/// against the definition's own input record, so a renamed or added
/// parameter cannot drift from its description.
/// </para>
/// </remarks>
public static class CalculationModuleDescriptors
{
    ...
    /// <summary>Every module descriptor, in registration order.</summary>
    ...
    [
        new(BeamDeflectionCalculationDefinition.Id, "Beam bending and deflection", "Structural",
            ...
            [
                ...
                Q("YoungsModulus", "Young's modulus E", nameof(Pressure), "GPa", "> 0; from the material record", "The material's modulus of elasticity."),
                ...
                Q("AllowableBendingStress", "Allowable bending stress", nameof(Pressure), "MPa", "> 0", "The stress the maximum bending stress is compared against."),
        ...
        new(BoltedJointPreloadCalculationDefinition.Id, "Bolted joint preload and clamp force", "Fasteners",
            ...
            Docs + "calc.bolted-joint-preload.md",
            [
        ...
        new(BoltGroupEccentricShearCalculationDefinition.Id, "Bolt group under eccentric in-plane load", "Fasteners",
            ...
            Docs + "calc.bolt-group-eccentric-shear.md",
            [
                ...
                List("Bolts", "Bolt positions", "At least one; no two coincident", "Each bolt's x and y in the group's in-plane frame.", "X", "Y"),
        ...
        new(FilletWeldThroatStressCalculationDefinition.Id, "Fillet weld throat stress", "Welds",
            ...
            Docs + "calc.fillet-weld-throat-stress.md",
            [
                ...
                Q("UltimateStrength", "Ultimate strength f_u", nameof(Pressure), "MPa", "> 0; from the material record", "The weaker part's ultimate strength."),
        ...
        new(LiftingLugPinJointCalculationDefinition.Id, "Lifting lug and pin joint", "Lifting",
            ...
            Docs + "calc.lifting-lug-pin-joint.md",
            [
        ...
        new(ColumnBucklingCalculationDefinition.Id, "Column buckling (Euler with Perry-Robertson)", "Structural",
            ...
            [
                ...
                Q("YoungsModulus", "Young's modulus E", nameof(Pressure), "GPa", "> 0; from the material record", "205 GPa for steel in BS 5950."),
                Q("YieldStrength", "Yield strength p_y", nameof(Pressure), "MPa", "> 0; from the material record", "The design strength."),
        ...
        new(ShaftCombinedStressCalculationDefinition.Id, "Shaft under combined torsion and bending", "Machine Elements",
            ...
            Docs + "calc.shaft-combined-stress.md",
            [
                ...
                Q("YieldStrength", "Yield strength S_y", nameof(Pressure), "MPa", "> 0; from the material record", "The material's yield strength."),
        ...
        new(BearingRatingLifeCalculationDefinition.Id, "Rolling bearing rating life L10", "Machine Elements",
            ...
            Docs + "calc.bearing-rating-life.md",
            [
        ...
        new(ThickWalledCylinderCalculationDefinition.Id, "Thick-walled cylinder stresses (Lame)", "Pressure Systems",
            ...
            Docs + "calc.thick-walled-cylinder.md",
            [
                ...
                Q("AllowableStress", "Allowable stress", nameof(Pressure), "MPa", "> 0", "The stress the maximum von Mises stress is compared against."),
            ]),
        ...
        new(ThermalExpansionStressCalculationDefinition.Id, "Thermal expansion and restrained thermal stress", "Thermal",
            ...
            Docs + "calc.thermal-expansion-stress.md",
            [
                ...
                Q("YoungsModulus", "Young's modulus E", nameof(Pressure), "GPa", "> 0; from the material record", "The material's modulus of elasticity."),
                Q("ExpansionCoefficient", "Expansion coefficient α", nameof(ThermalExpansion), "1/K", "> 0; from the material record", "The coefficient of linear thermal expansion."),
                ...
                Q("AllowableStress", "Allowable stress", nameof(Pressure), "MPa", "> 0", "The stress the stress magnitude is compared against."),
            ]),
        ...
        new(FatigueMinerCalculationDefinition.Id, "Fatigue under variable amplitude (S-N with Miner's rule)", "Fatigue",
            ...
            [
                ...
                List("Blocks", "Loading spectrum", "At least one block; range > 0, cycles >= 0", "Each block's stress range and cycle count.", "StressRange", "Cycles"),
            ]),
    ];

    /// <summary>The descriptor for <paramref name="calculationId"/>, or <see langword="null"/> where none of the modules has that Id.</summary>
    ...
    private static CalculationInputDescriptor Q(string name, string label, string dimension, string unit, string limits, string description, bool optional = false) =>
        new(name, label, CalculationInputKind.Quantity, dimension, unit, limits, description, IsOptional: optional);
