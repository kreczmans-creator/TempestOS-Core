...
{
    /// <summary>The runtime dimension vector for Dimensionless â see <see cref="Dimensions.Dimensionless"/>.</summary>
    public static Dimension Vector => Dimensions.Dimensionless;
