...
{
    /// <summary>The runtime dimension vector for ThermalExpansion â see <see cref="Dimensions.ThermalExpansion"/>.</summary>
    public static Dimension Vector => Dimensions.ThermalExpansion;
