...
{
    /// <summary>The runtime dimension vector for Acceleration â see <see cref="Dimensions.Acceleration"/>.</summary>
    public static Dimension Vector => Dimensions.Acceleration;
