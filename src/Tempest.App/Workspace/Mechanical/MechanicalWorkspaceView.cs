...
/// <see cref="IWorkspaceView"/> backed by <see cref="EngineeringDomainContext"/>
/// rather than fixed sample content (`ADR-0067`, `WP 9.0A`).
/// </summary>
public sealed class MechanicalWorkspaceView : IWorkspaceView
{
    private readonly EngineeringDomainContext _context;
    private string _title;

    /// <summary>Initialises a new instance of the <see cref="MechanicalWorkspaceView"/> class.</summary>
    public MechanicalWorkspaceView(Guid objectId, string objectKind, string initialTitle, EngineeringDomainContext context)
    {
