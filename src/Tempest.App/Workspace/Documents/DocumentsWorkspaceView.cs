...
/// — one instance serves whichever of the three Kinds <see cref="ObjectKind"/>
/// names, mirroring <see cref="Mechanical.MechanicalWorkspaceView"/>'s own
/// identical, simpler shape (no synthetic, non-Domain Kind here, unlike
/// Calculations' own Template).
/// </summary>
public sealed class DocumentsWorkspaceView : IWorkspaceView
{
    private readonly EngineeringDomainContext _context;
    private string _title;

    /// <summary>Initialises a new instance of the <see cref="DocumentsWorkspaceView"/> class.</summary>
    public DocumentsWorkspaceView(Guid objectId, string objectKind, string initialTitle, EngineeringDomainContext context)
    {
