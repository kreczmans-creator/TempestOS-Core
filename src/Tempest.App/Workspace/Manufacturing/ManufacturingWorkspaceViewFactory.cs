...
/// <c>"ManufacturingOperation"</c> — mirrors
/// <see cref="Mechanical.MechanicalWorkspaceViewFactory"/>'s own identical
/// shape.
/// </summary>
public sealed class ManufacturingWorkspaceViewFactory : IWorkspaceViewFactory
{
    private readonly EngineeringDomainContext _context;

    /// <summary>Initialises a new instance of the <see cref="ManufacturingWorkspaceViewFactory"/> class.</summary>
    public ManufacturingWorkspaceViewFactory(string kind, EngineeringDomainContext context)
    {
    ...
    public IWorkspaceView Create(Guid objectId, IWorkspaceContext context)
    {
        ...
        return new ManufacturingWorkspaceView(objectId, Kind, title, _context);
    }
}
