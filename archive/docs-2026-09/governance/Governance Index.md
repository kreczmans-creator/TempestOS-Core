...
- [Architecture Document Register](Architecture/Architecture%20Document%20Register.md) — all 46 standing architecture documents (44 under `docs/architecture/` plus 2 under `docs/releases/`), re-derived at the `v0.16.0` pre-release integration build; this line read 31 and was 15 behind that register's own Total.
